...
const App = () => {
  return (
    <div className="min-h-screen bg-gray-900 flex max-w-screen">
      <div>
        <Sidebar />
      </div>
      <div className="w-full flex flex-col">
        <Header />
        <div className="text-white bg-gray-100 h-full p-4">
          <div className="flex justify-between">
            <p className="text-gray-400">
              Workspace Creative <span>Creative Website</span>
            </p>
            <p className="text-black">From 23 April</p>
          </div>
          <div className="flex items-center justify-between py-4">
            <p className="text-black text-4xl">Website Design</p>
            ...
            <div className="flex gap-2 items-center">
              ...
              <div className="flex gap-4 ">
                <div className="flex gap-7">
                  ...
                  <ProfileImage src={p3}/>
                  <ProfileImage src={p4}/>
                  <div className="w-8 h-8 rounded-full bg-gray-600 text-center p-1">
                    +2
                  </div>
                </div>
